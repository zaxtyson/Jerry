...
buffer.
append("GET /foo/bar/index.html HTTP/1.1\r\n"
...
== "/foo/bar");
REQUIRE(req
.getHeader("Host") == "127.0.0.1:8081");
REQUIRE(req
.getHeader("User-Agent") == "HTTPie/2.5.0");
REQUIRE(req
...
== "foo=bar&blank1=&key=value&blank2=");
REQUIRE(req
.getParameter("foo") == "bar");
REQUIRE(req
